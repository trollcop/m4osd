...
FPU_HARD for hardware FP on Cortex M4 and do the following init in system_init():
 FPU->FPCCR &= ~FPU_FPCCR_ASPEN_Msk;    // FP context save off
 FPU->FPCCR &= ~FPU_FPCCR_LSPEN_Msk;    // lazy save off
*/
